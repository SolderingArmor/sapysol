...
class TokenCache:
    ...
    @staticmethod
    def __TokenFilename(tokenMint: Union[str, Pubkey]) -> str:
        return os.path.join(TokenCache.__TokenCachePath(), f"{MakePubkey(tokenMint)}.json")

    # ========================================
    #
    @staticmethod
    def __LoadFromFile(tokenMint: Union[str, Pubkey]) -> TokenCacheEntry:
        try:
    ...
    #
    @staticmethod
    def __LoadFromBlockchain(connection: Client, tokenMint: Union[str, Pubkey]) -> TokenCacheEntry:
        tokenCachePath: str = TokenCache.__TokenCachePath()
        tokenInfoFile:  str = TokenCache.__TokenFilename(tokenMint=tokenMint)
    ...
    #
    @staticmethod
    def UpdateTokenCache(connection: Client, tokenMint: Union[str, Pubkey]) -> TokenCacheEntry:
        return TokenCache.__LoadFromBlockchain(connection=connection, tokenMint=tokenMint)

    @staticmethod
    def GetToken(connection: Client, tokenMint: Union[str, Pubkey]) -> TokenCacheEntry:
